      ...
      <div className="fixed inset-0 bg-gradient-to-br from-slate-900 via-emerald-950 to-teal-950 flex items-center justify-center z-50 loading-screen">
        ...
        <div className="flex flex-col items-center justify-center space-y-6 relative z-10">
          ...
          <div className="relative">
            ...
            {/* Logo */}
            <div className="relative w-24 h-24 rounded-2xl overflow-hidden shadow-2xl shadow-emerald-500/40">
              <Image
                src="/logoMain.png"
                alt="Samhitha"
                width={96}
          ...
          <div className="text-center space-y-1">
            ...
            <p className="text-emerald-200/70 text-[11px] font-semibold tracking-[0.25em] uppercase">Admissions Tracker</p>
          </div>
          ...
          <div className="w-52 space-y-3">
            <div className="w-full bg-white/10 rounded-full h-1 overflow-hidden">
              <div
                className="bg-gradient-to-r from-emerald-400 via-teal-400 to-sky-400 h-1 rounded-full transition-all duration-500 ease-out"
